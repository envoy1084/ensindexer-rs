use std::{cmp, collections::BTreeSet, path::PathBuf, str::FromStr};
...
impl IngestService {
    pub async fn archive_range(
        ...
        anyhow::ensure!(
            ...
            "BACKFILL_SOURCE=raw cannot fetch new archive data"
        );
